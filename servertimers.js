...
function days_between(date1, date2) {
  ...
  var server_date = new Date(elem.title); // retrieve server time from html title element (2010/01/01 01:01:01)
  var server_date_ms = server_date.getTime();
  var date1_day = new Date(server_date.getTime());
  var date2_day = new Date(server_date.getTime());
...
function putDateTime(date1, shortDate) {
  ...
  if (shortDate == true) {
    // get todays date
    var date2 = new Date(elem.title); // retrieve server time from html title element (2010/01/01 01:01:01)
